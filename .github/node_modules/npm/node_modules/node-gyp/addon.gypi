    ...
    "target_defaults": {
                        ...
                        [
                            'OS=="win"',
                            {
                                ...
                                "msvs_settings": {
                                    "VCLinkerTool": {
                                        "DelayLoadDLLs": [
                                            "<(node_host_binary)<(EXECUTABLE_SUFFIX)"
                                        ],
        ...
        "conditions": [
            ...
            [
                'OS=="aix"',
                {
                    "ldflags": ["-Wl,-bimport:<(node_exp_file)"],
                },
            ],
            [
                'OS=="zos"',
                {
                    ...
                    "defines": ["_ALL_SOURCE=1", "MAP_FAILED=-1", "_UNIX03_SOURCE=1"],
                    "ldflags": ["-q64", "<(node_exp_file)"],
                },
            ],
            [
                'OS=="win"',
                {
                    "conditions": [
                        [
                            ...
                            {
                                "library_dirs": [
                                    "<(node_root_dir)/$(ConfigurationName)"
                                ],
